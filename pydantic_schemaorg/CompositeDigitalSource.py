...
class CompositeDigitalSource(IPTCDigitalSourceEnumeration):
    ...
    Model depth: 6
    """
    valid_name: ClassVar[str] = "CompositeDigitalSource"
    type_: str = Field("CompositeDigitalSource", alias='@type')
