...
class ScreenCaptureDigitalSource(IPTCDigitalSourceEnumeration):
    ...
    Model depth: 6
    """
    valid_name: ClassVar[str] = "ScreenCaptureDigitalSource"
    type_: str = Field("ScreenCaptureDigitalSource", alias='@type')
