...
class MultiFrameComputationalCaptureDigitalSource(IPTCDigitalSourceEnumeration):
    ...
    Model depth: 6
    """
    valid_name: ClassVar[str] = "MultiFrameComputationalCaptureDigitalSource"
    type_: str = Field("MultiFrameComputationalCaptureDigitalSource", alias='@type')
